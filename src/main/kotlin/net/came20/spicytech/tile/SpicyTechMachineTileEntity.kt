...
abstract class SpicyTechMachineTileEntity(numStacks: Int): TileEntity(), IInventory, ITickable {
    private val itemStacks = Array<ItemStack>(numStacks, {ItemStack.EMPTY})
